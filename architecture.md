...
* **Environment & Lighting**: Offshore oil rig platform equipped with **8 green helipad lights** and **10 red structure lights** set against dynamic ocean waves and day/night weather cycles[cite: 1].
...
* **`oil_rig.glb`**: Offshore platform 3D model serving as the primary helipad and NDB beacon target[cite: 1].
